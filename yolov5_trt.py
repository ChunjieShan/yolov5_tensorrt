...
class YoLov5TRT(object):
    ...
    def infer(self, input_image_path):
        ...
        print("The inference time: {:.2f} ms".format(infer_time * 1000))
        ...
        save_name = os.path.join("./outputs", "output_" + filename)
        # 　Save image
...
if __name__ == "__main__":
    ...
    # ]
    categories = ["Walking", "Holding Something", "Eating"]

    # a  YoLov5TRT instance
    print("Loading TensorRT engine: ", engine_file_path)
    ...
    for file in os.listdir("samples"):
        image_path = os.path.join("samples", file)
        thread1 = myThread(yolov5_wrapper.infer, [image_path])
        thread1.start()
        thread1.join()
